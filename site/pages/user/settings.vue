      ...
      <div class="modal-card">
        <div class="widget">
          ...
          <div class="widget-footer is-right">
            <a @click="setUsername" class="button is-link">确定</a>
    ...
    <div :class="{ 'is-active': showSetEmail }" class="modal">
      ...
      <div class="modal-card">
        <div class="widget">
          ...
          <div class="widget-footer is-right">
            <a @click="setEmail" class="button is-link">确定</a>
    ...
    <div :class="{ 'is-active': showSetPassword }" class="modal">
      ...
      <div class="modal-card">
        <div class="widget">
          ...
          <div class="widget-footer is-right">
            <a @click="setPassword" class="button is-link">确定</a>
    ...
    <div :class="{ 'is-active': showUpdatePassword }" class="modal">
      ...
      <div class="modal-card">
        <div class="widget">
          ...
          <div class="widget-footer is-right">
            <a @click="updatePassword" class="button is-link">确定</a>
